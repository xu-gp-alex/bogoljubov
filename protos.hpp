...
extern u64 get_white_pawn_moves(i32 square, u64 occupancy);
extern u64 get_black_pawn_moves(i32 square, u64 occupancy);
...
extern bool is_move_legal(const Board &board, i32 start, i32 end, i32 en_peasant, bool k_castle, bool q_castle, Side side); // evil
...
Board make_move(const Board &board, i32 start, i32 end, i32 en_peasant, bool k_castle, bool q_castle, Side side); // evil
