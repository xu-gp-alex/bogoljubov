...
// extern u64 get_rook_legal_moves(i32 square, u64 occupancy, u8 side);
// extern u64 get_rook_captures(i32 square, u64 occupancy, u8 side);
...
extern bool accept_move(i32 start, i32 end, i32 piece_type, u64 occupancy, u8 side);
// extern bool is_legal(i32 start, i32 end, i32 piece_type, u64 occupancy, u8 side);
